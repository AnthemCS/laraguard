    ...
    <div class="container">
        <div class="row">
            <div class="col my-3">
                <h3 class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="{{ route('reservations.store') }}" class="btn btn-primary">Save and Continue</a>
        ...
        <div class="row">
            ...
            <div class="col-md-6 order-2">
                ...
                <div class="form-row">
                    <div class="form-group{{ $errors->has('arrival_date') ? ' has-error' : '' }} col-md-4">
                    ...
                    <div class="form-group{{ $errors->has('departure_date') ? ' has-error' : '' }} col-md-4">
                    ...
                    <div class="form-group{{ $errors->has('nights') ? ' has-error' : '' }} col-md-4">
